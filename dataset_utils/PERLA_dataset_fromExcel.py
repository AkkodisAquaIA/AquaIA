...
# === PARAMÈTRES ===
fichier_excel = "/home/sarah.laroui/Bureau/AQUA-IA/Docs/PERLA_taxo_info.xlsx"
...
fichier_excel_sortie = "/home/sarah.laroui/Bureau/AQUA-IA/Docs/PERLA_taxo_info_classeIA.xlsx"
...
colonnes_requises = ["filename", "FAMILLE", "GENRE", "ESPECE"]
...
for index, row in df.iterrows():
    ...
    nom_dossier = f"{famille}_{genre}_{espece}"

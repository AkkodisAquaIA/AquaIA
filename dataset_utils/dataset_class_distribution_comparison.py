...
def count_images_per_class(root_path, extensions=(".jpg", ".jpeg", ".png", ".tif", ".tiff")):
    ...
    print(f"{root_path} -> nb class = {existing_classes}")
    return counts
...
def plot_images_per_class_two_paths(
    ...
    plt.xticks(x, CLASSES_IA, rotation=90)
    plt.xlabel("Classes IA")
    plt.ylabel("Nombre d'images")
    plt.title("Comparaison du nombre d'images par classe")
    plt.legend()
    plt.tight_layout()
    plt.show()


plot_images_per_class_two_paths(

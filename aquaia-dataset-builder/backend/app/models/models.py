...
class Dataset(Base):
	...
	images: Mapped[list["ImageRecord"]] = relationship("ImageRecord", secondary=dataset_images, back_populates="datasets")
...
class Taxon(Base):
	...
	reference_image_id: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
	created_at: Mapped[datetime] = mapped_column(DateTime, default=datetime.utcnow)
...
class ImageRecord(Base):
	...
	datasets: Mapped[list["Dataset"]] = relationship("Dataset", secondary=dataset_images, back_populates="images")

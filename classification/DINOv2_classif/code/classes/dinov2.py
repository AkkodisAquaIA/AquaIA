...
from classes.ClassifierHead import ClassifierHead
...
class DinoV2Segmentor(nn.Module):
	...
	def __init__(self, channels=512, num_classes=3, k_size=3, activation="relu", size="base", n_features=1, peft=True, quantize=True, r=32, lora_alpha=32, lora_dropout=0.1, inference_mode=False):
		...
		self.seg_head = ClassifierHead(self.embedding_size, self.num_classes, self.n_features)
